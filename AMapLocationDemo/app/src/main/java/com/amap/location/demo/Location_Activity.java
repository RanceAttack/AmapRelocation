...
public class Location_Activity extends CheckPermissionsActivity
    ...
    private void initView() {
        ...
        SharedPreferences sp = getSharedPreferences(SP, Activity.MODE_WORLD_READABLE);
        String str = sp.getString("location.getAddress()", "没有定位");
        btSave.setText(str);
        ...
        btSave.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (mCachedLocation == null) {
                    btSave.setText("没有新定位");
                } else {
                    saveLocation(mCachedLocation);
                    SharedPreferences sp = getSharedPreferences(SP, Activity.MODE_WORLD_READABLE);
                    String str = sp.getString("location.getAddress()", "没有定位");
                    btSave.setText(str);
                }
    ...
    public static final String SP = "test";

    private synchronized void saveLocation(AMapLocation location) {
        SharedPreferences sp;
        SharedPreferences.Editor editor;
        sp = getSharedPreferences(SP, Activity.MODE_WORLD_READABLE);
        editor = sp.edit();
        editor.putFloat("getLongitude", (float) location.getLongitude());
        editor.putFloat("getLatitude", (float) location.getLatitude());
        editor.putFloat("getAccuracy", location.getAccuracy());
//        editor.putInt("getLocationType", location.getLocationType());
        editor.putString("getCountry", location.getCountry());
        editor.putString("getProvince", location.getProvince());
        editor.putString("getCity", location.getCity());
        editor.putString("getCityCode", location.getCityCode());
        editor.putString("getDistrict", location.getDistrict());
        editor.putString("getAdCode", location.getAdCode());
        editor.putString("getAddress", location.getAddress());
        editor.putString("getBuildingId", location.getBuildingId());
        editor.putString("getDescription", location.getDescription());
        editor.putString("getDistrict", location.getDistrict());
        editor.putString("getLocationDetail", location.getLocationDetail());
        editor.putString("getStreet", location.getStreet());
        editor.putString("getStreetNum", location.getStreetNum());
        editor.putString("getAoiName", location.getAoiName());

        WifiManager wifiManager = (WifiManager) getApplicationContext().getSystemService(WIFI_SERVICE);
        WifiInfo wifiInfo = wifiManager.getConnectionInfo();
        editor.putString("getBSSID", wifiInfo.getBSSID());
        editor.putString("getMacAddress", wifiInfo.getMacAddress());
